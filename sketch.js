...
function setup() {
  ...
  //step 1.4
  invisibleGround = createSprite(windowWidth/2,windowHeight-10,windowWidth,125);  
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(windowWidth+20,windowHeight-300,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    ...
    // step 1.9
    var obstacle = createSprite(600,windowHeight-95,20,30);
